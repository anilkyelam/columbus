...
% removed the "and are ubiquitous" phrase here because it didnt make sense
...
the latency of atomic operations on a \amirian{Anil, the figure caption says
8B, this seems to be a discrepancy???}4B memory region as we slide the region
