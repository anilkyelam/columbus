...
\amirian{I think it makes more sense to pair all the analysis parts together and
keep it separate from the theory. So take EVALUATION and FEASIBILITY study and
but them under their own section}
\label{sec:eval}
