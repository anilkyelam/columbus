...
segment of the Cloud services market. These services are
...
serverless computing are not well understood. In this work, we construct a covert
channel, a means of transmitting data outside of traditional channels, that is
practical for AWS lambdas. We extend the work in Wu et al. to utilize the
memory-bus and develop a co-residence detector that is generic, reliable, and
...
this work, we show that efforts to secure co-residency detection on cloud 
platforms are not yet complete.
