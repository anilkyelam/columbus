...
data transfer on AWS lambdas.  We show that we can establish tens of individual
covert channels for every 1000 lambdas, and each of those channels can send data
at a rate of ~200 bits per second, thus demonstrating the feasibility of covert
communication via lambdas.
