...
light-weight and provide more flexibility in scheduling and cost, which
...
We establish that a fast co-residence detection for lambdas 
is key to enabling such a covert channel, and proceed to develop a 
reliable, and scalable co-residence detector based on the memory
