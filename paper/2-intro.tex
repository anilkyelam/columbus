...
the globe~\todo{cite; can also throw in numbers to make  this more convincing}.
...
mechanisms\todo{cite}, which further weaken the encapsulation model. Clouds
...
previously known mechanisms. \amirian{this sentence feels awkward}Since other
...
\amirian{need to work in more terms like the path to scalability, reliable transmission, sampling freq/duration, sensing contention, overcoming noise}
In this paper, we focus on \emph{co-operative} co-residence detection, to
create a proof of concept technique.  In a co-operative setting, all lambdas
are assumed to be in the attacker's control.  \amirian{this sounds
unconvincing}Co-operative co-location still allows the attacker to perform
targeted DDoS attacks \todo{cite power attacks?} or learn the cloud's internal
