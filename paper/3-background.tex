...
\anil{Did not like how this turned out, Ariana, reverting it. 
If you remember the first time around, this section was very piecemeal 
and contained lot of unrelated text, and we struggled to polish it, and it felt like 
a step back. I think its ok to just remove the related work section :). I may have 
lost some of your minor writing improvements by reverting the whole thing, I'll 
work on integrating them later.}
