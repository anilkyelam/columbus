...
To correct these errors, we use Reed-Solomon coding, block-based error correction 
...
symbols? - that would be } as there are errors to correct. So, for each bitrate, we must compute
