...
def main():
    ...
    defaulturl = "https://6fdhepb68i.execute-api.me-south-1.amazonaws.com/latest"    # ap-east-1
    ...
    parser.add_argument('-u', '--url', action='store', help='url to call', default=defaulturl)
